					...
					'choices'      => array(
						...
						'silkberry'    => array(
							...
							'options' => array(
								...
								'cards_icon_border_color'     => '#3c3133',
						...
						'Orangina'    => array(
							...
							'options' => array(
								...
								'cards_icon_color'            => '#ffffff',
								'cards_icon_border_color'     => '#ffffff',
					...
					'options' => array(
						...
						'page_titles_color'  => array(
							...
							'css'     => array(
								array(
									'property' => 'color',
									'selector' => '.page-title,
										.front-page-section .widget_title,
						...
						'page_subtitles_color'     => array(
							...
							'css'     => array(
								array(
									'property' => 'color',
									'selector' => '.front-page-section .widget_subtitle',
								),
							)
						),
						'text_color'         => array(
				...
				'cards' => array(
					...
					'options' => array(
						...
						'thumbs_radius'               => array(
							...
							'css'         => array(
								array(
									'selector' => '.front-page-section .categories .category-cover',
									'property' => 'border-radius',
									'unit'     => 'px'
								)
							)
				...
				'body_font' => array(
					...
					'options' => array(
						'body_font' => array(
							...
							'default'          => array( 'Source Sans Pro', 'regular' ),
							'recommended'      => $recommended_body_fonts
						),
					)
				),
					...
					'options' => array(
						'page_subtitles_font' => array(
							...
							'selector'         => '.intro,
									...
									.woocommerce-account:not(.logged-in) .woocommerce form.login input[type="submit"],
									.woocommerce .button,
									.front-page-section .widget_subtitle,
									.category-list a,
				...
				'card_title_font' => array(
					...
					'options' => array(
						'card_title_font'           => array(
							...
							'selector'         => '.card__title.card__title, .front-page-section .categories .category-count,
