...
/**
 * ======  WP Job Manager Products - https://astoundify.com/downloads/wp-job-manager-products/  ======
 */
...
class Listing_Sidebar_Products_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$title           = apply_filters( 'widget_sidebar_title', empty( $instance ) ? $placeholders['title'] : $instance['title'], $instance, $this->id_base );
