			...
			array(
				...
				, 'params'				=> Array(
					Array(
						...
						, 'param_name'	=> 'action'
						, 'value'		=> apply_filters(
							'javo_get_map_templates'
							, Array( __("Default Search Page", 'javo_fr') => '' )
						)
					)
					, Array(
						'type'			=> 'checkbox'
						...
						, 'value'		=> Array(
							...
							, __( "Google Autocomplete", 'javo_fr' )	=> 'google'
						)
					)
					, Array(
						'type'			=> 'dropdown'
						, 'heading'		=> __( "Display Border", 'javo_fr')
						, 'holder'		=> 'div'
						, 'class'		=> ''
						, 'param_name'	=> 'display_border'
						, 'value'		=> Array(
							__( "Enable", 'javo_fr')				=> ''
							, __( "Disabled", 'javo_fr')			=> 'hide'
						)
					)
				)
			)
