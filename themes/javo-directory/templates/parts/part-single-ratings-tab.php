						...
						<?php
							...
							if( !empty( $javo_this_part_ratings ) ){
								foreach( $javo_this_part_ratings as $key => $value ){
									...
									<div class="progress">
										<div class="progress-bar progress-bar-blue progress-bar-striped" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo (round($value) / 5) * 100;?>%;">
